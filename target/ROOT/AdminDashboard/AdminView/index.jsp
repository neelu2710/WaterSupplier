...
//if(admin !=null && !admin.getEmailid().equals("null")){
if(true){%>
         ...
         <jsp:include page="admin_header.jsp"></jsp:include>       
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                ...
                                <div class="span3">
                                    ...
                                    <div class="chart-bottom-heading"><span class="label label-info">blog viewer</span>
            ...
            <%}else{ %>
          <jsp:include page="wrong_adminpwd.jsp"></jsp:include>
        <%} %>
        </div>
            <hr>
