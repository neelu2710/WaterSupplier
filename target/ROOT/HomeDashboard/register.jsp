...
<body>
 ...
 <div class="container">
    ...
    <form class="well form-horizontal" action="/user/save" method="post"  id="user_reg_form">
<fieldset>
...
<div class="form-group">
  <label class="col-md-4 control-label" >Confirm Password</label> 
    ...
    <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
  <input name="confPassword" placeholder="Confirm Password" class="form-control"  type="text">
    </div>
  </div>
</div>
<div class="form-group">
